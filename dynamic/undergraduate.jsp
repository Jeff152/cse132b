    ...
    <body>
        ...
        <%
            ...
            if ((action != null) && action.equals("insert")) {
                ...
                if (crs.getInt(1) == 0) {
                        ...
                        PreparedStatement cstmt = connection.prepareStatement("INSERT INTO undergraduate VALUES (?, ?, ?)");
                        cstmt.setInt(1, Integer.parseInt(request.getParameter("student_id")));
                        cstmt.setString(3, request.getParameter("college"));
                        cstmt.setBoolean(2, request.getParameter("fiveyear") != null);
                        cstmt.executeUpdate();
        ...
        <div>
            ...
            <form action="undergraduate.jsp" method="GET">
                ...
                Major: <input type="input" name="major" required><br /><br />
                Minor: <input type="input" name="minor" required><br /><br />
