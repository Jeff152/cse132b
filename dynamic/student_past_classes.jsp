...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Adding a new Student Past Class Home Page</title>
    </head>
    <body>
        ...
        <%
            ...
            if ((action != null) && action.equals("insert")) {
                ...
                PreparedStatement pcheck = connection.prepareStatement("SELECT COUNT(*) FROM prev_classes WHERE student_id = (?) AND course_title = (?) AND section_id = (?) AND qtr_year = (?)");
                ...
                if (rs.getInt(1) > 0) {
                        // conflicting key!
                        exists = true;
                        error_msg = "Student was already enrolled in this class!";
                } else {
                        // Begin transaction
                        ...
                        if (rs.getInt(1) == 0){ 
                            ...
                            PreparedStatement pstmt = connection.prepareStatement("INSERT INTO prev_classes VALUES (?, ?, ?, ?, ?, ?)");
                            ...
                            pstmt.executeUpdate();
                            created = true;
                            success_msg = "Recorded the student in " + course_title + " with a grade of " + request.getParameter("grade") + "!";
                        // }
        ...
        <div>
            ...
            <form action="student_past_classes.jsp" method="GET">
                ...
                <br /><br />Units: <input type="number" name="units" min="0" max="100"><br /><br />
